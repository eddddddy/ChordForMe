...
weights_chord_types_out = tf.Variable(tf.random_normal([num_hidden_1, translate.num_chord_types], stddev=1/np.sqrt(num_hidden_1)))
...
out_chord_types = tf.matmul(layer_dropout_chord_types_1, weights_chord_types_out) + biases_chord_types_out
...
for i in range(num_training_steps):
    ...
    sess.run(train_chord_types_op, feed_dict={data: batch_data, keep_prob: 1, labels_chord_types: batch_labels_chord_types})
